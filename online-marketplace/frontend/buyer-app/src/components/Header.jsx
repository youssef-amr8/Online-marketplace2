...
const Header = () => {
  ...
  const { selectedCity, openLocationPrompt } = useLocation();
  ...
  const displayLocation = selectedCity || "Select Location";
  ...
  return (
    <header className="header">
      <div className="header-container">
        ...
        {/* Location Selector */}
        <div className="header-location" onClick={openLocationPrompt}>
          <div className="location-top">Deliver to</div>
        ...
        <Link to="/orders" className="header-orders">
          <span className="orders-returns">Returns</span>
          <span className="orders-text">& Orders</span>
        </Link>

        {/* Messages */}
        <Link to="/messages" className="header-messages">
          <svg
